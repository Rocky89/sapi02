...
public class SCRUMAcceptanceTestTitleStepDefinition {
	...
	public void I_enter_in_the_title_textbox_and_I_push_the_add_button(
		...
		WebElement titleTextBox = driver.findElement(By.id("acceptancetest-title"));
		titleTextBox.clear();
		titleTextBox.sendKeys(additionTerms);

		// Click on searchButton
		WebElement searchButton = driver.findElement(By.id("add-acceptancetest-button"));
		searchButton.click();
	}

	@Then("^I should get result \"([^\"]*)\" in acceptance tests list$")
	public void I_should_get_result_in_stories_list(String expectedResult)
			throws Throwable {
		WebElement calculatorTextBox = driver.findElement(By.id("acceptancetest-title"));
